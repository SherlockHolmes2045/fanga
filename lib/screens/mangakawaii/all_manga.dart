        ...
        if (_scrollController.position.pixels ==
          ...
          if (_scrollController.position.pixels > triggerFetchMoreSize) {
            if (context.read<MangakawaiiMangaListProvider>().hasNext)
              context.read<MangakawaiiMangaListProvider>().getMangaList(
                  Assets.mangakawaiiCatalogName,
                  context.read<MangakawaiiMangaListProvider>().nextPage);
          }
        }
      });
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      context.read<MangakawaiiMangaListProvider>().mangaList.fold((l) => null,
          (r) {
        if (r.isEmpty) {
          context.read<MangakawaiiMangaListProvider>().getMangaList(
              Assets.mangakawaiiCatalogName,
              context.read<MangakawaiiMangaListProvider>().currentPage);
        }
      });
    });
  }
