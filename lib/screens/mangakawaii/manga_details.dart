...
class _MangakawaiiDetailState extends State<MangakawaiiDetail> {
  List<String> menu = [
    "Télécharger",
    "Marquer ce chapitre",
    "Marquer comme lu",
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      context.read<MangakawaiiDetailsProvider>().mangaDetails.fold((l) => null,
          (r) {
      ...
      context.read<MangakawaiiChapterProvider>().mangaChapters.fold((l) => null,
          (r) {
        print(context.read<MangakawaiiChapterProvider>().currentManga.url);
        if (r.isEmpty ||
            widget.manga !=
                context.read<MangakawaiiChapterProvider>().currentManga) {
          context
              ...
              child: WillPopScope(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      context
                                  .watch<MangakawaiiDetailsProvider>()
                                  .loadingState ==
                          ...
                          : context
                              .select((MangakawaiiDetailsProvider provider) =>
                                  provider)
                              .mangaDetails
