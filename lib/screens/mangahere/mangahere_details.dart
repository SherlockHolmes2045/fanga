...
class _MangahereDetailState extends State<MangahereDetail> {
  List<String> menu = [
    "Télécharger",
    "Marquer ce chapitre",
    "Marquer comme lu",
              ...
              child: WillPopScope(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      context.watch<MangahereDetailsProvider>().loadingState ==
                          ...
                          : context
                              .select((MangahereDetailsProvider provider) =>
                                  provider)
                              .mangaDetails
                                                            ...
                                                            child: Column(
                                                              children: [
                                                                ...
                                                                RaisedButton(
                                                                  onPressed:
                                                                      () {
                                                                    context.read<MangahereChapterProvider>().getChapters(
                                                                        Assets
                                                                                  ...
                                                                                  if (context.read<ActionProvider>().selectedItems.isNotEmpty) {
                                                                                    ...
                                                                                    Navigator.push(
                                                                                        ...
                                                                                        ScaleRoute(
                                                                                            page: ReaderLoader(
                                                                                          manga: widget.manga,
                                                                                          catalog: Assets.mangahereCatalogName,
