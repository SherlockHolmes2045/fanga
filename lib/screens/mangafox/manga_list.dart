...
import 'package:manga_reader/screens/mangafox/manga_details.dart';
...
class _MangaListState extends State<MangaList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      context.read<MangafoxProvider>().popularMangaList.fold((l) => null, (r) {
        if (r.isEmpty) {
          context
              .read<MangafoxProvider>()
              .getPopularMangaList(Assets.mangafoxCatalogName, 1);
        }
      });
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
        child: context.watch<MangafoxProvider>().loadingState ==
          ...
          child: CircularProgressIndicator(
            ...
            : context
            .select((MangafoxProvider provider) => provider)
            .popularMangaList
            ...
            child: Column(
              ...
              children: [
                ...
                RaisedButton(onPressed: (){
                  context.read<MangafoxProvider>().getPopularMangaList(Assets.mangafoxCatalogName, 1);
                },
                  child: Text(
                      "Réessayer"
                  ),
